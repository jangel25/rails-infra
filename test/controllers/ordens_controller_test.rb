...
class OrdensControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create orden" do
    assert_difference('Orden.count') do
      post ordens_url, params: { orden: { cliente_id: @orden.cliente_id, fecha: @orden.fecha, numero: @orden.numero } }
    end
  ...
  test "should update orden" do
    patch orden_url(@orden), params: { orden: { cliente_id: @orden.cliente_id, fecha: @orden.fecha, numero: @orden.numero } }
